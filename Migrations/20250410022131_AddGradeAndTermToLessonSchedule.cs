...
{
    /// <inheritdoc />
    public partial class AddGradeAndTermToLessonSchedule : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_LessonSchedules_Grades_GradeId",
                        column: x => x.GradeId,
                        principalTable: "Grades",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_LessonSchedules_Instructors_InstructorId",
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_LessonSchedules_Terms_TermId",
                        column: x => x.TermId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_LessonSchedules_GradeId",
                table: "LessonSchedules",
                column: "GradeId");

            migrationBuilder.CreateIndex(
                name: "IX_LessonSchedules_InstructorId",
                table: "LessonSchedules",
                column: "InstructorId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_LessonSchedules_TermId",
                table: "LessonSchedules",
                column: "TermId");
        }
